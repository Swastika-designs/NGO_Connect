...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/dashboard/messages" element={<PrivateRoute><MessagesPage /></PrivateRoute>} />
      <Route path="/dashboard/messages/:userId" element={<PrivateRoute><MessagesPage /></PrivateRoute>} />
      ...
      <Route path="/dashboard/attendance/:eventId" element={<PrivateRoute roles={['ngo']}><AttendancePage /></PrivateRoute>} />
      <Route path="/opportunities" element={<OpportunitiesPage />} />
      <Route path="/dashboard/post-opportunity" element={<PrivateRoute roles={['ngo','admin']}><PostOpportunity /></PrivateRoute>} />
