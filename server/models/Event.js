...
const eventSchema = new mongoose.Schema({
  ...
  category: {
    ...
    enum:['Environment','Education','Healthcare','Disaster Relief','Women Empowerment','Food & Hunger','Animal Welfare','Other'],
    default:'Other',
  },
  targetAudience:  { type:String, default:'' },
  date:            { type:Date },
  time:            { type:String, default:'' },
  duration:        { type:String, default:'' },   // e.g. "4 hours", "Full day"
